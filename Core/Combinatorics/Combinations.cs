...
[assembly: System.Diagnostics.CodeAnalysis.SuppressMessage("Naming", "CA1710:Identifiers should have correct suffix",
    Justification = "3rd party code",
    Scope = "namespaceanddescendants",
    Target = "Core.Combinatorics")]
...
namespace Core.Combinatorics
{
    ...
    public class Combinations<T> : IMetaCollection<T>
    {
        ...
        /// </summary>
        private class Enumerator : IEnumerator<IList<T>>
        {
            ...
            /// </summary>
            public void Reset() => myPermutationsEnumerator.Reset();
        ...
        public Combinations(IList<T> values, int lowerIndex) : this(values, lowerIndex, GenerateOption.WithoutRepetition)
        {
        }
